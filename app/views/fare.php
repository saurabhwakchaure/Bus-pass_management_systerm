...
रा.प. महामंडळाची मालवाहतूक सेवा " अधिक माहितीसाठी संपर्क क्र :- ०२२-२३०२४०६८</marquee>
        ...
        <div class="mydiv1">
            <h4><marquee style="background-color:indigo;color:yellow;">Note:Please Check The fare of Route You Want to Go</marquee><h4>
        </div>
        ...
        <table class="table table-striped table-hover bg-white table-responsive-sm">
            <thead class="bg-dark">
                <tr>
                    <bold><th class="text-danger">id</th></bold>
                    <bold><th class="text-danger">from</th></bold>
                    <bold><th class="text-danger">to</th></bold>
                    <bold><th class="text-danger">price(for NORMAL Bus Same for sleeper AS WELL)</th></bold>
                    <bold><th class="text-danger">price(for AC Bus)</th></bold>
            ...
            <tbody>
               <?php
                  ...
                  foreach($detail as $demo)
                  {
                    ...
                    echo "<tr>";?>
                    <td class="bg-light"><?php echo $demo['id'] ?></td>
                    <td class="bg-light"><?php echo $demo['from'] ?></td>
                    <td class="bg-light"><?php echo $demo['to'] ?></td>
                    <td class="bg-light"><?php echo $demo['price_for_normal_bus'] ?></td>
                    <td class="bg-light"><?php echo $demo['price_for_AC_bus'] ?></td>
                    </tr>
                    <?php
                  }
                 ?>
        ...
        <a href="booking"><button type="button" class="btn btn-warning" style="margin-left:400px;" title="book">Book</button></a>
