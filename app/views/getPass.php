...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        ...
                        <a href="dashboardserver"><button type="button" class="btn btn-warning" title="book" style="margin-left:220px;margin-right:20px;">Home</button></a></td>
                        <a href="getTransactionPass"><button type="button" class="btn btn-warning" title="book">Transaction</button></a></td>
                     </div>
                    </div>
                </nav>
            </div>
        ...
        <h2 style=" margin-top:20px;margin-left:550px;" class="title">STUDENT DETAILS</h2>
        ...
        <table class="table table-striped table-hover bg-white table-responsive-sm">
            ...
            <tbody>
                  ...
                  foreach($detail as $demo)
                  {
                      ...
                      echo "<td>",$demo['identity']."</td>";
                      echo "<td>",$demo['bonafidefile']."</td>";
                      echo "<td>",$demo['bonafide']."</td>";
                      echo "<td>",$demo['subject']."</td>";
                 //    echo "<td>".'<img src="\x6c6f676f312e706e67,'.$demo['subject']."</td>";
                      ?>
                      <td><a href="printPass/<?= $demo['id']; ?>"><button type="button" class="btn btn-info" title="book">Approv</button></a></td>
                      <td><a href="deletePass/<?= $demo['id']; ?>"><button type="button" class="btn btn-danger" title="book">Delete</button></a></td>
                      <?php
                  }?>
