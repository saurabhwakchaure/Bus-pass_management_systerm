            ...
            <div class="container">
                <div class="d-flex justify-content-between topbar">
                    ...
                    <div class="top-link">
                        ...
                        <a href="#" class="btn btn-danger btn-lg btn-block" style="margin-left:30px;">
                ...
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        <div class="navbar-nav">
                            <a href="#"><button type="button" class="btn btn-warning" title="book" style="margin-left:90px;">Fare</button></a>
                            <a href="getBooking"><button type="button" class="btn btn-warning" title="book" style="margin-left:10px;">Tickets</button></a>
                            <a href="getPass"><button type="button" class="btn btn-warning" title="book"  style="margin-left:10px;">Pass</button></a>
                            <a href="aboutdepo"><button type="button" class="btn btn-warning" title="book"  style="margin-left:10px;">About</button></a>
                        </div>
                    </div>
                </nav>
            </div>
