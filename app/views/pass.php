...
रा.प. महामंडळाची मालवाहतूक सेवा " अधिक माहितीसाठी संपर्क क्र :- ०२२-२३०२४०६८</marquee>
        ...
        <!-- form -->
        <div class="container">
  <form action="insertpass" method="post">
  <div class="row">
  <h2 style="margin-left:360px;" class="title">PASS DETAILS</h2>
    <div class="col-25">
  ...
  <div class="col-75">
    <input type="text" id="lname" name="from" placeholder="from..." required>
  </div>
  </div>
  <div class="row">
  <div class="col-25">
  ...
  <div class="col-75">
    <input type="text" id="lname" name="to" placeholder="to..." required>
  </div>
  </div>
  <div class="row">
  <div class="col-25">
  ...
  <div class="col-75">
    <input type="date" id="lname" name="fromdate" placeholder="from date..." required>
  </div>
  </div>
  <div class="row">
  <div class="col-25">
  ...
  <div class="col-75">
    <input type="date" id="lname" name="todate" placeholder="to date... " required>
  </div>
  </div>
  <div class="row">
  <div class="col-25">
  ...
  <div class="col-75">
    <input type="text" id="lname" name="price" placeholder="Enter price here(refer to price table)..." required>
  </div>
  </div>
  <div class="row">
  <div class="col-25">
  ...
  <div class="col-75">
    <input type="file" id="file" name="identity" placeholder="identity" required>
  </div>
  </div>
  <div class="row">
  <div class="col-25">
    <label>Your Bonafide</label>
  </div>
  <div class="col-75">
    <input type="file" id="file" name="bonafidefile" placeholder="Bonafide" required>
  </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <select name="bonafide" placeholder="Bonafide" required>
        <option disabled="disabled" selected="selected">Bonafide</option>
            <option>Yes</option>
            <option>No</option>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <textarea id="subject" name="subject" placeholder="Write something(Plz fill your contact_no here...)" style="height:200px" requrired></textarea>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="subject">Scan QR Here</label>
    </div>
    <div class="col-75">
