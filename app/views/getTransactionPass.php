            ...
            <div class="container">
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        ...
                        <a href="getPass"><button type="button" class="btn btn-warning" title="book" style="margin-left:300px;margin-right:10px;">Pass</button></a></td>
                    </div>
                    </div>
                </nav>
            </div>
        ...
        <table class="table table-striped table-hover bg-white table-responsive-sm">
            ...
            <?php
                  foreach($detail as $demo)
                  {
                      ...
                      ?>
                      <td><a href="deleteTransactionPass/<?= $demo['id']; ?>"><button type="button" class="btn btn-danger" title="book">Delete</button></a></td>
                    <?php
