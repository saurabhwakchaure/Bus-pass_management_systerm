...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="d-flex justify-content-between topbar">
                    ...
                    <div class="top-link">
                        ...
                        <a href="https://twitter.com/msrtcMumbai" class="bg-light nav-fill btn btn-sm-square rounded-circle"><i class="fab fa-twitter text-primary"></i></a>
        ...
        <!-- Navbar Start -->
        <div class="mydiv1">
            <marquee>Note:For Any Assistance/Queries in respect of online Reservation/Pass system ,contact our call-centre No:1800221250</marquee>
        </div>
                ...
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        <div class="navbar-nav">
                            <a href="myui" class="navbar navbar-light bg-info" style="margin-left:500px;margin-right:20px;padding:15px;"><h4>Home</h4></a>
                        </div>
                    </div>
                </nav>
            </div>
