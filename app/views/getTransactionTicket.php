...
<html lang="en">
    ...
    <body>
        ...
        <!-- Navbar Start -->
        <div class="mydiv1">
            <marquee>NOTE:IF ANY INVALID CASE PLEASE DELETE THE BOOKING IMMEDIATELY</marquee>
        </div>
                ...
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        <div class="navbar-nav">
                            <a href="getBooking"><button type="button" class="btn btn-warning" title="book" style="margin-left:300px;margin-right:20px;">Ticket</button></a></td>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <h2 style=" margin-top:20px;margin-left:500px;" class="title">TRANSACTION DETAILS</h2>
        ...
        <table class="table table-striped table-hover bg-white table-responsive-sm">
            ...
            <?php
                  foreach($detail as $demo)
                  {
                      ...
                      echo "<td>".$demo['transactionid']."</td>";
                      ?>
                      <td><a href="deleteTransactionBooking/<?= $demo['id']; ?>"><button type="button" class="btn btn-danger" title="book">Delete</button></a></td>
                     <?php
